...
PROJECT_NAME = 'xenon-point-368810'

MODEL_PATH = 'gs://seshaditya-datastore/dataset_full/models/cygnus.pt'
FS = gcsfs.GCSFileSystem(project=PROJECT_NAME)

with FS.open(MODEL_PATH, 'rb') as handle:
     mymodel = torch.load(handle)
     
MODEL_PATH = 'gs://seshaditya-datastore/dataset_full/models/tmodel5.pkl'

with FS.open(MODEL_PATH, 'rb') as handle1:
     model1 = pickle.load(open(handle1))

#mymodel = torch.load('models/cygnus.pt')
#model1 = pickle.load(open('tmodel5.pkl', 'rb'))
le1 = pickle.load(open('tlabel5.pkl', 'rb'))
